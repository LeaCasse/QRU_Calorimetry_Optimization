...
batch_size = 20
nb_epoch = 30
num_runs = 100  # Number of runs to measure variability
...
# Huber loss function
def huber_loss(yh, gt, delta=1.0):
    error = yh - gt
...
# Log file name
log_file = "classification_variability.log"
...
def run_training(log_file, run):
    ...
    opt = torch.optim.Adagrad([params], lr=0.5)
...
plt.savefig("Test_Accuracies_Variability.png", dpi=300)
plt.show()
